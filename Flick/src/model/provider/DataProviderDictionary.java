...
public class DataProviderDictionary {
	...
	public static BaseResourceDataProvider<?> getDataProviderByResourceName(String name){
		return resourceNameProviderMap.get(name);
	}
	
	
	public static BaseResourceDataProvider<?> getDataProviderByResourceElementClass(Class<?> clazz){
	...
	static{
		...
		elemClassProviderMap = new HashMap<Class<?>, BaseResourceDataPriovider<?>>();
		
		elemClassProviderMap.put(FriendDataProvider.class, fdp);
		
		resourceNameProviderMap = new HashMap<String,BaseResourceDataProvider<?>>();
		
		resourceNameProviderMap.put("friend-data", fdp);
	}
